    ...
    <div className='w-full h-full'>
      ...
      <div className='flex flex-col gap-8 justify-center text-center w-full h-3/4'>
        <div className='w-full text-center'>
          <h2 className='text-6xl font-semibold'>Transform <span className="textBackground">Healthcare</span> Efficiency</h2>
          <h2 className='text-6xl font-semibold'>with Cutting-Edge Technology</h2>
        </div>
